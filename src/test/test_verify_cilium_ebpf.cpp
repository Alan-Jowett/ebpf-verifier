...
TEST_PROGRAM_REJECT("cilium-ebpf", "kfunc-el.elf", "tp_btf/task_newtask", "call_weak_kfunc", 2)
TEST_PROGRAM_REJECT("cilium-ebpf", "kfunc-el.elf", "tp_btf/task_newtask", "weak_kfunc_missing", 2)
